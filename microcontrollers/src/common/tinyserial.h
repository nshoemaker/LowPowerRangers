...
extern void ts_init(unsigned int, unsigned char) __asm__("ts_init");
extern void ts_putc(unsigned char) __asm__("ts_putc");
extern void ts_puts(char*) __asm__("ts_puts");
